...
- 페이지 끝에 도달 시, 다음 페이지의 목록이 자동으로 로드되는 구조입니다.
- 페이지 로드 속도와 부하 최소화를 위해 쓰로틀링 및 메모이제이션을 적용하였습니다.
...
- 기존 스크롤 감지로 인한 API 요청 빈도가 3초당 한 번으로 감소하였습니다.
...
- Zip 아카이브를 사용한 의존성 관리와 Zero Install 적용으로, 프로젝트 협업이 원활해졌습니다.
- Typescript 호환성 문제가 발생하여 오류를 해결하기까지 시간을 크게 소요하였습니다.

<span style="background-color: #FDFD96; font-weight: bold;">배운점 및 개선방향</span>

- Webpack과 Babel의 초기 설정을 진행하면서 호환성 문제의 해결 방안을 경험하였습니다.
